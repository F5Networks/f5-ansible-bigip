...
DOCUMENTATION = r'''
---
module: bigip_security_ssh_profile_rules
...
options:
  ...
  action:
    ...
    suboptions:
      ...
      shell:
        description:
          - Defines the use of the C(shell) command to open an SSH shell channel
            type.
        type: dict
        suboptions:
          control:
            description:
              ...
              - When set to C(terminate), the SSH connection is terminated with reset
