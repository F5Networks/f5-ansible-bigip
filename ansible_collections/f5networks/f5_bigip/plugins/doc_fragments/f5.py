    ...
    suboptions:
      password:
        description:
          ...
          - You may omit this option by setting the environment variable C(F5_PASSWORD) or C(ANSIBLE_NET_PASSWORD).
        type: str
        required: true
        aliases: [ pass, pwd ]
      server:
      ...
      server_port:
        description:
          ...
          - You may omit this option by setting the environment variable C(F5_SERVER_PORT) or C(ANSIBLE_REMOTE_PORT).
        type: int
        default: 443
      user:
        description:
          ...
          - You may omit this option by setting the environment variable C(F5_USER)
            or C(ANSIBLE_NET_USERNAME) or C(ANSIBLE_REMOTE_USER).
        type: str
        required: true
      validate_certs:
        description:
...
notes:
  ...
  - Requires BIG-IP software version >= 13.
